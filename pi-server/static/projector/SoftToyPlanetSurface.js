...
const BUMP_SCALE = 0.11;
// Radial relief for the paint, in world units against a body radius of 1.05.
// Raised to ~8–9% so the molded pads read as thick soft-plastic features
// matching the clay/toy reference images (previous 0.055 was too flat).
const DISPLACEMENT_SCALE = 0.09;
...
const STROKE_HEIGHT_TIERS = [0.5, 0.75, 1.0];
// Texels of smoothstep in from a stroke's edge, giving the pad a rounded
// shoulder instead of a cliff. With the denser 96×72 sphere the previous
// 6-texel shoulder was still a bit hard; 11 gives the soft fillet seen in
// the clay/toy reference images.
const SHOULDER_TEXELS = 11;
