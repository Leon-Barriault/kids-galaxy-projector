...
// Radial relief for the paint, in world units against a body radius of 1.05, so
...
// shoulder instead of a cliff. Measured against the geometry, not the texture:
// the body sphere has 72 height segments across 256 texture rows, so one vertex
// row spans about 3.5 texels and a shoulder under ~4 is quantised back into a
// single step. Six is about two vertex rows and still only 4 degrees.
const SHOULDER_TEXELS = 6;
// How much darker a stroke's rounded edge is than its flat top. This is the
